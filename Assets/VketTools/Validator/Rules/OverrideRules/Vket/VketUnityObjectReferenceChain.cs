...
{
    public class VketUnityObjectReferenceChain
    {
        public readonly IReadonlyReferenceDictionary Result;

        public static VketUnityObjectReferenceChain ExploreFrom(IEnumerable<Object> objects)
        {
            return new VketUnityObjectReferenceChain(objects);
        }

        private VketUnityObjectReferenceChain(IEnumerable<Object> objects)
        {
        ...
        private static void FindMaterialReferenceRecursive(Material material, ReferenceDictionary dictionary)
        {
            ...
            dictionary.AddReference(material, material.shader);
        }
