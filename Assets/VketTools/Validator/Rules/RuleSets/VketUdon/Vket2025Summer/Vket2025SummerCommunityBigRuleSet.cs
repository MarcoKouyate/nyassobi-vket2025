...
namespace VketTools.Validator.RuleSets
{
    ...
    /// </summary>
    public class Vket2025SummerCommunityBigRuleSet : VketUdonRuleSetBase
    {
        public Vket2025SummerCommunityBigRuleSet() : base(new Vket2025SummerOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2025Summer - Community (Big)";
