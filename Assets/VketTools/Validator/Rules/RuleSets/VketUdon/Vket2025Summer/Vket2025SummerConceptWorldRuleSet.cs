...
namespace VketTools.Validator.RuleSets
{
    ...
    /// 標準ブース
    /// </summary>
    public class Vket2025SummerConceptWorldRuleSet : VketUdonRuleSetBase
    {
        public Vket2025SummerConceptWorldRuleSet() : base(new Vket2025SummerOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2025Summer - Default";
