...
namespace VketTools.Validator.RuleSets
{
    ...
    /// 企業ブース
    /// </summary>
    public class Vket2025SummerCorporateRuleSet : VketUdonRuleSetBase
    {
        public Vket2025SummerCorporateRuleSet() : base(new Vket2025SummerOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2025Summer - Corporate";
        
        protected override long FolderSizeLimit => 100 * MegaByte;

        protected override Vector3 BoothSizeLimit => new(15, 8, 10);
        ...
        public override IRule[] GetRules()
        {
            ...
            // 企業ブースは範囲外にオブジェクトが置かれることも想定し範囲チェックを行わない仕様
