...
namespace Vket.VketPrefabs
{
    public class VketChairSettingWindow : VketPrefabSettingWindow
    {
        ...
        private void OnGUI()
        {
            ...
            /* "1.見た目にする3Dモデルの設定" */
            EditorGUILayout.LabelField(LocalizedUtility.Get("VketChairSettingWindow.VisualSetting"), _l3Style);
            ...
            EditorGUILayout.HelpBox(LocalizedUtility.Get("VketChairSettingWindow.VisualSetting.Help"), MessageType.Info);

            GUILayout.Space(3);

            /* "2.見た目となる3DオブジェクトからColliderを削除" */
            EditorGUILayout.LabelField(LocalizedUtility.Get("VketChairSettingWindow.VisualColliderDeleteButton"), _l3Style);
            ...
            EditorGUILayout.HelpBox(LocalizedUtility.Get("VketChairSettingWindow.VisualColliderDeleteButton.Help"), MessageType.Warning);

            GUILayout.Space(3);

            /* "3.座る位置の調整" */
            EditorGUILayout.LabelField(LocalizedUtility.Get("VketChairSettingWindow.EnterLocationSetting"), _l3Style);
            EditorGUI.BeginChangeCheck();
            ...
            if (GUILayout.Button(LocalizedUtility.Get("VketChairSettingWindow.SelectEnterLocationButton")))
            {
            ...
            EditorGUILayout.HelpBox(LocalizedUtility.Get("VketChairSettingWindow.SelectEnterLocationButton.Help"), MessageType.Info);
