...
namespace Vket.VketPrefabs
{
    public class VketWebPageOpenerSettingWindow : VketPrefabSettingWindow
    {
        ...
        private void OnGUI()
        {
            ...
            {
                /* "1.サイズの調整" */
                EditorGUILayout.LabelField(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.SizeSetting"), _l3Style);
                ...
                /* "2.画像設定" */
                EditorGUILayout.LabelField(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.TextureSetting"), _l3Style);
            ...
            {
                /* "1.見た目にする3Dモデルの設定" */
                EditorGUILayout.LabelField(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.VisualSetting"), _l3Style);
                EditorGUI.BeginChangeCheck();
                ...
                /* "2.コライダーのサイズ調整" */
                EditorGUILayout.LabelField(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.ColliderScaleSetting"), _l3Style);
                ...
                EditorGUILayout.LabelField(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.VisualColliderDeleteButton"), _l3Style);
            ...
            if (_type == 2 || _type == 3)
            {
                ...
                {
                    /* "3.Item IDを指定" */
                    EditorGUILayout.LabelField(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.ItemIdSetting.2D"), _l3Style);
                }
                else
                {
                    /* "4.Item IDを指定" */
                    EditorGUILayout.LabelField(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.ItemIdSetting.3D"), _l3Style);
                }
                ...
                EditorGUILayout.HelpBox(LocalizedUtility.Get("VketWebPageOpenerSettingWindow.ItemIdSetting.Help"), MessageType.Info);
            }
